# Writing to a .csv file with sample data
...
print("Example of writing to a .csv file with data:\n")
print("<<< Writing to test_logger1.csv >>>\n")

with open('test_logger1.csv', 'w') as test_logger1:
